...
public class ChallengeService {
    ...
    public ChallengeResponse add(String userName, String title, String description){
        //  토큰으로 로그인한 아이디 비교
    ...
    public ChallengeResponse modify(String userName, Long postId, ChallengeRequest challengeRequest){
        ...
        if(!Objects.equals(challenge.getOwner().getNickname(),user.getNickname()) && !user.getRole().equals(Role.ADMIN)) {
